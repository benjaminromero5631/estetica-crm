...
export default function CalendarioPage() {
  ...
  function citasForDay(day: number): Cita[] {
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden" style={{ border: '1px solid #E2E8F0' }}>
          ...
          <div className="grid grid-cols-7">
            {Array.from({ length: totalCells }).map((_, idx) => {
              ...
              const dayCitas = isCurrentMonth ? citasForDay(dayNum) : []
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 px-4 py-2 text-sm font-medium text-white rounded-lg hover:opacity-90 transition-opacity disabled:opacity-60"
                style={{ background: clinicConfig.primaryColor }}
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6">
            <div className="flex items-start justify-between mb-4">
              ...
              <button onClick={() => setDetailCita(null)} className="text-slate-400 hover:text-slate-600 mt-1">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full mt-3 py-2 text-xs text-red-500 hover:bg-red-50 rounded-lg transition-colors"
            >
